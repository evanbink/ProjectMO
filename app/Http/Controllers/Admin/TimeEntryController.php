...
class TimeEntryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.timeEntries.create', compact('work_types', 'projects', 'clients'));
    }
    ...
    public function edit(TimeEntry $timeEntry)
    {
        ...
        $timeEntry->load('work_type', 'project', 'clients');

        return view('admin.timeEntries.edit', compact('work_types', 'projects', 'clients', 'timeEntry'));
    }
